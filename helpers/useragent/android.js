class AndroidUserAgentList {
  ...
  toString() {
    ...
    switch (this.uaType) {
      case "dalvik":
        return `Dalvik/2.1.0; U; Android ${this.androidVersion}; ${this.androidDevice} Build/${this.androidBuildVersion})`
      case "firefox":
        return `Mozilla/5.0 (Android ${this.androidVersion}; Mobile; rv:${this.firefoxVersion}.0) Gecko/${this.firefoxVersion}.0 Firefox/${this.firefoxVersion}.0`
    }
  }
}
